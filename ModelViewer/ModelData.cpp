...
void ModelData::add_curve_to_tree(QTreeWidgetItem *parent, SGM::Curve CurveID)
{
    ...
    switch (nType)
        ...
        case SGM::LineType:
            ...
            snprintf(Data, sizeof(Data), "(%.15G, %.15G, %.15G)", Axis[0], Axis[1], Axis[2]);
        ...
        case SGM::CircleType:
            ...
            snprintf(Data, sizeof(Data), "(%.15G, %.15G, %.15G)", Normal[0], Normal[1], Normal[2]);
