...
#define SEED_POINT_EDGE_ANGLE_TOL 0.26794919243112270647255365849413 // 15 degrees.
#define SEED_POINT_HALF_ANGLE_TANGENT 0.13089969389957471826927680763665  //tangent of half-angle = 7.5 degrees
